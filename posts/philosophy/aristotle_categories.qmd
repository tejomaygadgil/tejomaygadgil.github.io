...
Consider your phone. It is a particular entity. *Your phone could never describe another entity*; rather it can only *be* described, by either by its model, color, size, shape, and so on (in other words, by generic predicates).
