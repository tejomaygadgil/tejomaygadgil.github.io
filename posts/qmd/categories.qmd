...
subtitle: Get drawn into the most remarkable essay in the history of philosophy.
date: "2023-11-07"
format:
  html:
    comments:
...
Predicates define a subject (καθ' ὑποκειμένου λέγεται). Man, for instance, is the entity that defines a person, and color defines what blue is. Predicates are always generic.
...
This makes them predicate synonymously: if this man is a man, then he is also the definition of man, animal. But properties are homonymous: a man's having a certain skin shade does not imply he is a color.

Species is more like substance than genre:

- It is "nearer" to substance in that it is a better substitute: it is more fitting to call to this man a man than to call him an animal.
...
- They alone *define* first substance. No property of a man -- his height, knowledge, age, posture -- answers what he is: a man.
